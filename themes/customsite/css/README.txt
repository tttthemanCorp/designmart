...
To use these stylesheets, rename the files and customsite with the name of your theme.
...
customsite-alpha-default-narrow.css  
...
customsite-alpha-default-normal.css
...
customsite-alpha-default-wide.css
